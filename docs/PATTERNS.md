...
| Database      | [database.md](patterns/database.md)           | Drizzle ORM, caching, soft delete, transactions, TOCTOU prevention, batch CASE/WHEN, CHECK constraints, JSONB safety        |
